# -*- coding: utf-8 -*-
"""Organico ufficiale Eccellenza Campania/Lazio Girone B 2026/27 + loghi Tuttocampo."""
...
IMG_DIR = Path(
    ...
    r"\C%3A%5CWINDOWS%5Csystem32\01a052f5-236a-7db0-af7b-f131918b1c4e\images"
)
...
# Screenshot Tuttocampo app: coppie (sinistra, destra) per riga
SHOTS = [
    {
        "file": "image-113e8cf3-5b78-42e8-8fd0-49c8e09d9c77.png",
        "league": "ECCELLENZA · CAMPANIA · GIRONE B",
        "gid": "campania-b",
        "title": "Campania · Girone B",
        "area": "Eccellenza · organico ufficiale 2026/27 (18 squadre)",
        "pairs": [
            (("Agerola", "Agerola"), ("Heraclea", "Policastro Bussentino")),
            (("Alta Hirpinia", "Lioni"), ("LMM Montemiletto", "Montemiletto")),
            (("Apice Calcio", "Apice"), ("Poggio de Marinis", "Poggiomarino")),
            (("Battipagliese", "Battipaglia"), ("Rossoblu Castel San Giorgio", "Castel San Giorgio")),
            (("Citta di Campagna", "Campagna"), ("Salernum Baronissi", "Baronissi")),
            (("Citta di Pontecagnano", "Pontecagnano Faiano"), ("San Vito Positano", "Positano")),
            (("Citta di Solofra", "Solofra"), ("Sanseverinese", "Mercato San Severino")),
            (("Costa d'Amalfi", "Maiori"), ("Sporting Ponte", "Ponte")),
            (("GS Telese Terme", "Telese Terme"), ("US Angri", "Angri")),
        ],
    },
    {
        "file": "image-1c948253-4f14-450b-a8d8-d6b9c9afe91a.png",
        "league": "ECCELLENZA · LAZIO · GIRONE B",
        "gid": "lazio-b",
        "title": "Lazio · Girone B",
        "area": "Eccellenza · organico ufficiale 2026/27 (18 squadre)",
        "pairs": [
            (("Alatri", "Alatri"), ("Pomezia", "Pomezia")),
            (("Arce 1932", "Arce"), ("Real San Basilio", "Roma")),
            (("Cassino", "Cassino"), ("Roccasecca", "Roccasecca")),
            (("Citta di Formia", "Formia"), ("Roma City", "Roma")),
            (("Citta Monte San Giovanni Campano", "Monte San Giovanni Campano"), ("Salaria FC", "Roma")),
            (("Ferentino", "Ferentino"), ("SS Romulea", "Roma")),
            (("Lodigiani", "Roma"), ("Sterparo", "Paliano")),
            (("Lupa Frascati", "Frascati"), ("Terracina", "Terracina")),
            (("Polisportiva Gaeta", "Gaeta"), ("Vis Sezze", "Sezze")),
        ],
    },
]
...
def abbr(name: str) -> str:
    skip = {"FC", "AS", "US", "SSD", "ASD", "AC", "SC", "GS", "LMM", "SS", "CITTA", "DI", "CALCIO", "CLUB"}
...
def row_centers(bgr: np.ndarray, n_rows: int) -> list[int]:
    h, w = bgr.shape[:2]
    # App Tuttocampo Classifica: stessa griglia 2 col x 9 righe
    first = int(h * 0.338)
    last = int(h * 0.812)
    if n_rows <= 1:
        return [first]

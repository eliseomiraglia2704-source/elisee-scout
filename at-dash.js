...
(function () {
  ...
  function html(user) {
    ...
    return '<aside class="es-pd-rail">' +
      ...
      '<figure>' + spark([32, 40, 48, 55, 64, 74, 86], '#c4b08a') + '<figcaption>Carico di lavoro medio</figcaption></figure>' +
      '<figure>' + spark([70, 62, 55, 48, 42, 38, 34], '#f87171') + '<figcaption>Infortuni da sovraccarico</figcaption></figure>' +
      '<figure>' + spark([40, 48, 52, 58, 66, 74, 82], '#c4b08a') + '<figcaption>Livello di forma</figcaption></figure>' +
      '<figure>' + spark([48, 55, 60, 66, 74, 82, 90], '#8a9a7a') + '<figcaption>Stagione</figcaption></figure>' +
      '</div></section>' +

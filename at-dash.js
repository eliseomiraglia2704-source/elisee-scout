...
(function () {
  ...
  function html(user) {
    ...
    return '<aside class="es-pd-rail">' +
      ...
      '<div class="es-pd-radar-tools"><span>Seleziona dati radar</span><span>Analisi attività di preparazione atletica</span></div>' +
      radarSvg() + '</section>' +
  ...
  function bind(host) {
    ...
    host.addEventListener('click', function (e) {
      ...
      if (k === 'edit') {
        host.classList.remove('es-at-on');
        var dash = document.getElementById('es-atd');
        if (dash) dash.hidden = true;
        var g = document.getElementById('user-dossier-view-group');
        if (g) g.classList.remove('is-at-dash');
      }
    });
  }

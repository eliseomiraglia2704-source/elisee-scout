...
(function () {
  ...
  function html(user) {
    ...
    return '<aside class="es-pd-rail">' +
      ...
      '<figure>' + spark([32, 40, 48, 55, 64, 74, 86], '#c4b08a') + '<figcaption>Sessioni specifiche</figcaption></figure>' +
      '<figure>' + spark([28, 36, 44, 52, 60, 72, 84], '#8a9a7a') + '<figcaption>Parate allenate</figcaption></figure>' +
      '<figure>' + spark([40, 48, 52, 58, 66, 74, 82], '#c4b08a') + '<figcaption>Progressi portieri</figcaption></figure>' +

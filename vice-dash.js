/* ============================================================
   ELISEE SCOUT — AREA VICE ALLENATORE CAPO (HEAD COACH CONTROL ROOM)
...
(function () {
  ...
  function getCoachData() {
    ...
    var base = {
      ...
      coachRole: u.staffRole || 'Allenatore in seconda',
  ...
  function renderHub(user) {
    ...
    if (portal) portal.classList.add('is-vice-dash');
    var inner = portal ? portal.querySelector('.pf-page-inner') : null;
    if (inner) inner.classList.add('is-vice-inner');
        ...
        '<main class="es-cos-main">' +
          ...
          '<div class="card es-cos-card es-cos-dash-header">' +
            ...
            '<div class="es-cos-header-top-row">' +
              ...
              '<div class="es-cos-header-identity">' +
                '<div class="es-cos-header-block">' +
                  ...
                  '<div class="es-cos-coach-info">' +
                    ...
                    '<span class="role">Allenatore in seconda / Vice Allenatore</span>' +
              ...
              '<button type="button" class="es-cos-btn-vice-jump" id="btn-goto-coach-area">' +
                'Area Allenatore Capo &rarr;' +
              '</button>' +
            '</div>' +
  ...
  function bindAllEvents() {
    ...
    var btnGotoCoach = mount.querySelector('#btn-goto-coach-area');
    if (btnGotoCoach) {

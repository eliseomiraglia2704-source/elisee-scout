# -*- coding: utf-8 -*-
"""Organico ufficiale Eccellenza Molise 2026/27 + loghi Tuttocampo."""
...
SHOTS = [
    {
        "file": "image-f237a780-c121-4474-bdab-2258bccb94b3.png",
        "league": "ECCELLENZA · MOLISE",
        "gid": "molise",
        "title": "Molise",
        "area": "Eccellenza · organico ufficiale 2026/27 (15 squadre)",
        "pairs": [
            (("Aesernia Fraterna", "Isernia"), ("FC Matese", "Piedimonte Matese")),
            (("Alife", "Alife"), ("Olympia Agnonese", "Agnone")),
            (("Atletico Torremaggiore", "Torremaggiore"), ("Pietramontecorvino", "Pietramontecorvino")),
            (("Aurora Alto Casertano", "Capriati a Volturno"), ("Real Guglionesi", "Guglionesi")),
            (("Bojano", "Bojano"), ("San Leucio", "Isernia")),
            (("CNC Sporting", "Campomarino"), ("Sesto Campano", "Sesto Campano")),
            (("Calcio Montenero", "Montenero di Bisaccia"), ("United Alife", "Alife")),
...
def row_centers(bgr: np.ndarray, n_rows: int) -> list[int]:
    h, w = bgr.shape[:2]
    first = int(h * 0.338)
    last = int(h * 0.805) if n_rows <= 8 else int(h * 0.812)
    if n_rows <= 1:
        return [first]

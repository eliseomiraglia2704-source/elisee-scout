...
(function () {
  ...
  function html(user) {
    ...
    return '<aside class="es-pd-rail">' +
      ...
      '<figure>' + spark([32, 40, 48, 56, 66, 76, 88], '#c4b08a') + '<figcaption>Materiale gestito</figcaption></figure>' +
      '<figure>' + spark([28, 36, 44, 54, 64, 76, 90], '#8a9a7a') + '<figcaption>Ordini evasi</figcaption></figure>' +
      '<figure>' + spark([22, 30, 38, 48, 58, 70, 84], '#c4b08a') + '<figcaption>Interventi di manutenzione</figcaption></figure>' +

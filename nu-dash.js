...
(function () {
  ...
  function html(user) {
    ...
    return '<aside class="es-pd-rail">' +
      ...
      trendSvg() +
      '<div class="es-nu-legend"><span><i style="background:#c4b08a"></i>2023</span>' +
      '<span><i style="background:#8a9a7a"></i>2024</span>' +
      '<span><i style="background:#c4b08a"></i>2025</span></div></section>' +
      '</div>' +

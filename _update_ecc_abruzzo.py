# -*- coding: utf-8 -*-
"""Organico ufficiale Eccellenza Abruzzo 2026/27 + loghi Tuttocampo."""
...
SHOTS = [
    {
        "file": "image-fc8c6dfc-b271-44c6-9dd3-09ef3308541d.png",
        "league": "ECCELLENZA · ABRUZZO",
        "gid": "abruzzo",
        "title": "Abruzzo",
        "area": "Eccellenza · organico ufficiale 2026/27 (18 squadre)",
        "pairs": [
            (("Bacigalupo Vasto Marina", "Vasto"), ("Mosciano", "Mosciano Sant'Angelo")),
            (("Celano", "Celano"), ("Ovidiana Sulmona", "Sulmona")),
            (("Chieti 1922", "Chieti"), ("Pontevomano", "Pontevomano")),
            (("Forza e Coraggio Avezzano", "Avezzano"), ("Pro Vasto", "Vasto")),
            (("Folgore Delfino Curi", "Pescara"), ("Rosetana", "Roseto degli Abruzzi")),
            (("Francavilla 1927", "Francavilla al Mare"), ("San Giovanni Teatino", "San Giovanni Teatino")),
            (("Fucense Trasacco", "Trasacco"), ("San Salvo", "San Salvo")),
            (("Montesilvano 1954", "Montesilvano"), ("Torrese", "Torre de' Passeri")),
            (("Montorio 88", "Montorio al Vomano"), ("Virtus Cupello", "Cupello")),
        ],
    },
]

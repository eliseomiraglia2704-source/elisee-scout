...
(function () {
  ...
  const DICT = {
    it: {
      ...
      'home.aboutText': 'ELISEE SCOUT connette calciatori, società, scout e staff tecnico in Italia — con dossier verificati, dati GPS, video highlights e compliance GDPR.',
    ...
    es: {
      ...
      'home.aboutText': 'ELISEE SCOUT conecta jugadores, clubes, ojeadores y staff técnico en Italia — con dossiers verificados, datos GPS, vídeos highlights y cumplimiento GDPR.',
    ...
    fr: {
      ...
      'home.aboutText': 'ELISEE SCOUT relie joueurs, clubs, scouts et staff technique en Italie — dossiers vérifiés, GPS, vidéos highlights et conformité RGPD.',

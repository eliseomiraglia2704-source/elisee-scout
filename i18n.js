...
(function () {
  ...
  const DICT = {
    it: {
      ...
      'about.metaSeat': 'Sede',
      'about.metaSeatVal': 'Foggia, Italia',
      'about.metaContact': 'Contatti',
      'about.metaScope': 'Ambito',
      'about.metaScopeVal': 'Reclutamento calcistico',
      'about.missionLabel': 'La nostra missione',
      'about.mission1a': 'Connettiamo il sistema calcistico italiano — dalla Serie D alla Terza Categoria — con un unico principio guida:',
      'about.mission1em': 'zero fake account, opportunità reali, nessun rischio',
      'about.mission1b': ' per chi si affida alla piattaforma.',
      'about.mission2': 'Ogni profilo è verificato tramite documento d\'identità, ogni dato sportivo è tracciato con GPS, e ogni trattamento — a partire dagli atleti minorenni — segue gli articoli 13 e 30 del GDPR con consenso genitoriale obbligatorio.',
      'about.quote': '«La nostra forza è la fiducia: zero fake account, opportunità reali, mai un rischio.»',
      'about.quoteCite': '— Elisee Scout',
      'about.heroLine1': 'CHI',
    ...
    en: {
      ...
      'about.headline': 'The Italian football market, verified.',
      'about.lede': 'Elisee Scout digitises recruitment in amateur, youth and free-agent football in Italy, connecting players, clubs, scouts and technical staff with verified dossiers, GPS data and highlight videos, in full GDPR compliance.',
      ...
      'about.metaSeat': 'Seat',
      'about.metaSeatVal': 'Foggia, Italy',
      'about.metaContact': 'Contact',
      'about.metaScope': 'Scope',
      'about.metaScopeVal': 'Football recruitment',
      'about.missionLabel': 'Our mission',
      'about.mission1a': 'We connect the Italian football system — from Serie D to Terza Categoria — around one guiding principle:',
      'about.mission1em': 'zero fake accounts, real opportunities, no risk',
      'about.mission1b': ' for anyone who trusts the platform.',
      'about.mission2': 'Every profile is verified with an identity document, every sporting datum is GPS-traced, and every processing operation — starting with minors — follows GDPR articles 13 and 30 with mandatory parental consent.',
      'about.quote': '“Our strength is trust: zero fake accounts, real opportunities, never a risk.”',
      'about.quoteCite': '— Elisee Scout',
      'about.heroLine1': 'WHO',
    ...
    es: {
      ...
      'about.headline': 'El mercado del fútbol italiano, verificado.',
      'about.lede': 'Elisee Scout digitaliza el reclutamiento en el fútbol amateur, juvenil y de agentes libres en Italia, conectando jugadores, clubes, ojeadores y staff técnico con dossiers verificados, datos GPS y vídeos highlights, en plena conformidad GDPR.',
      ...
      'about.metaSeat': 'Sede',
      'about.metaSeatVal': 'Foggia, Italia',
      'about.metaContact': 'Contacto',
      'about.metaScope': 'Ámbito',
      'about.metaScopeVal': 'Reclutamiento futbolístico',
      'about.missionLabel': 'Nuestra misión',
      'about.mission1a': 'Conectamos el sistema futbolístico italiano — de la Serie D a la Terza Categoria — con un único principio:',
      'about.mission1em': 'cero cuentas fake, oportunidades reales, ningún riesgo',
      'about.mission1b': ' para quien confía en la plataforma.',
      'about.mission2': 'Cada perfil se verifica con documento de identidad, cada dato deportivo se traza con GPS y cada tratamiento — empezando por los menores — sigue los artículos 13 y 30 del GDPR con consentimiento parental obligatorio.',
      'about.quote': '«Nuestra fuerza es la confianza: cero cuentas fake, oportunidades reales, nunca un riesgo.»',
      'about.quoteCite': '— Elisee Scout',
    ...
    fr: {
      ...
      'about.headline': 'Le marché du football italien, vérifié.',
      'about.lede': 'Elisee Scout numérise le recrutement dans le football amateur, des jeunes et des agents libres en Italie, en reliant joueurs, clubs, scouts et staff technique avec dossiers vérifiés, données GPS et vidéos highlights, en pleine conformité RGPD.',
      ...
      'about.metaSeat': 'Siège',
      'about.metaSeatVal': 'Foggia, Italie',
      'about.metaContact': 'Contact',
      'about.metaScope': 'Périmètre',
      'about.metaScopeVal': 'Recrutement football',
      'about.missionLabel': 'Notre mission',
      'about.mission1a': 'Nous relions le système footballistique italien — de la Serie D à la Terza Categoria — autour d’un seul principe :',
      'about.mission1em': 'zéro faux comptes, opportunités réelles, aucun risque',
      'about.mission1b': ' pour ceux qui font confiance à la plateforme.',
      'about.mission2': 'Chaque profil est vérifié par une pièce d’identité, chaque donnée sportive est tracée par GPS, et chaque traitement — à commencer par les mineurs — suit les articles 13 et 30 du RGPD avec consentement parental obligatoire.',
      'about.quote': '« Notre force, c’est la confiance : zéro faux comptes, opportunités réelles, jamais un risque. »',
      'about.quoteCite': '— Elisee Scout',
      'about.heroLine1': 'QUI',

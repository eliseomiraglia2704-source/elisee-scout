# -*- coding: utf-8 -*-
"""Organico ufficiale Eccellenza Campania Girone A 2026/27 + loghi Tuttocampo."""
...
SHOTS = [
    {
        "file": "image-223c9369-f5a3-424c-b0a6-4735bd6adae5.png",
        "league": "ECCELLENZA · CAMPANIA · GIRONE A",
        "gid": "campania-a",
        "title": "Campania · Girone A",
        "area": "Eccellenza · organico ufficiale 2026/27 (18 squadre)",
        "pairs": [
            (("Albanova 64", "Casal di Principe"), ("Portici 1906", "Portici")),
            (("Boys Caivanese", "Caivano"), ("Virtus Puteolana", "Pozzuoli")),
            (("Castel Volturno", "Castel Volturno"), ("Quarto 2012", "Quarto")),
            (("Ercolanese 1924", "Ercolano"), ("Rangers Qualiano", "Qualiano")),
            (("FC Pompei", "Pompei"), ("Real Bacoli Sibilla", "Bacoli")),
            (("Il Punto di Svolta", "Napoli"), ("Real Casoria", "Casoria")),
            (("Marianella", "Napoli"), ("Real Grazzanise", "Grazzanise")),
            (("Polisportiva Gricignano", "Gricignano di Aversa"), ("Santa Maria la Carità", "Santa Maria la Carità")),
            (("Pomigliano 1920", "Pomigliano d'Arco"), ("Virtus Stabia", "Castellammare di Stabia")),
        ],
    },
]

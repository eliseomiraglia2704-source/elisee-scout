...
(function () {
  ...
  function html(user) {
    ...
    return '<aside class="es-pd-rail">' +
      ...
      '<figure>' + spark([32, 40, 48, 55, 64, 74, 86], '#c4b08a') + '<figcaption>Trasferte gestite</figcaption></figure>' +
      '<figure>' + spark([28, 36, 44, 52, 60, 72, 84], '#8a9a7a') + '<figcaption>Pratiche evase</figcaption></figure>' +
      '<figure>' + spark([40, 36, 32, 28, 24, 20, 16], '#f87171') + '<figcaption>Incidenti logistici</figcaption></figure>' +
      '<figure>' + spark([48, 55, 60, 66, 74, 82, 90], '#c4b08a') + '<figcaption>Stagione</figcaption></figure>' +
      '</div></section>' +

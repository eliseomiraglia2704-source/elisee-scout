# -*- coding: utf-8 -*-
"""Organico ufficiale Eccellenza Veneto Girone B 2026/27 + loghi Tuttocampo."""
...
SHOTS = [
    {
        "file": "image-203f75dc-1dd5-4d4d-bd35-2f8ca9abd8b7.png",
        "league": "ECCELLENZA · VENETO · GIRONE B",
        "gid": "veneto-b",
        "title": "Veneto · Girone B",
        "area": "Eccellenza · organico ufficiale 2026/27 (16 squadre)",
        "pairs": [
            (("Arcella Padova", "Padova"), ("Liapiave", "San Polo di Piave")),
            (("Borgo Valbelluna", "Borgo Valbelluna"), ("Marosticense", "Marostica")),
            (("Cavarzano Belluno", "Belluno"), ("Portogruaro", "Portogruaro")),
            (("Dolo 1909", "Dolo"), ("Portomansu\u00e8", "Mansu\u00e8")),
            (("Eclisse Carenipievigina", "Pieve di Soligo"), ("Thiene 1908", "Thiene")),
            (("Galliera", "Galliera Veneta"), ("Union Monte", "Montebelluna")),
            (("Godigese", "Castello di Godego"), ("Union Pro", "Mogliano Veneto")),
            (("LeO Oderzo", "Oderzo"), ("United Borgoricco Campetra", "Borgoricco")),
        ],
    },
]

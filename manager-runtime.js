...
(function () {
  ...
  function ensureAdminUi() {
    ...
    var statsRow = document.querySelector('#es-cc-legacy-stats');
    if (statsRow && !$('stat-mgr-pending')) {
      var cell = document.createElement('div');
      cell.className = 'es-cc-pratica';
      cell.innerHTML = '<div id="stat-mgr-pending">0</div><span>Manager in attesa</span>';

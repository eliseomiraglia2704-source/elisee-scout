# -*- coding: utf-8 -*-
"""Organico ufficiale Eccellenza Toscana Girone A 2026/27 + loghi Tuttocampo."""
...
SHOTS = [
    {
        "file": "image-ff26188a-a106-4fce-88c4-b27dd3144a98.png",
        "league": "ECCELLENZA · TOSCANA · GIRONE A",
        "gid": "toscana-a",
        "title": "Toscana · Girone A",
        "area": "Eccellenza · organico ufficiale 2026/27 (16 squadre)",
        "pairs": [
            (("Belvedere Calcio", "Grosseto"), ("Pietrasanta", "Pietrasanta")),
            (("Camaiore", "Camaiore"), ("Real Cerretese", "Cerreto Guidi")),
            (("Castelnuovo Garfagnana", "Castelnuovo di Garfagnana"), ("Real Forte Querceta", "Forte dei Marmi")),
            (("Fratres Perignano", "Perignano"), ("San Giuliano", "San Giuliano Terme")),
            (("Fucecchio", "Fucecchio"), ("Sporting Cecina", "Cecina")),
            (("Lampo Meridien", "Lamporecchio"), ("Tuttocuoio", "San Miniato")),
            (("Larcianese", "Larciano"), ("Viareggio", "Viareggio")),
            (("Mobilieri Ponsacco", "Ponsacco"), ("Zenith Prato", "Prato")),
        ],
    },
]

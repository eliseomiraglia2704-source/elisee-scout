...
(function () {
  ...
  function html(user) {
    ...
    return '<aside class="es-pd-rail">' +
      ...
      '<figure>' + spark([18, 22, 28, 34, 40, 48, 58], '#c4b08a') + '<figcaption>Promossi in prima squadra</figcaption></figure>' +
      '<figure>' + spark([40, 48, 52, 58, 66, 74, 82], '#8a9a7a') + '<figcaption>Risultati categorie</figcaption></figure>' +
      '<figure>' + spark([28, 36, 44, 52, 60, 72, 84], '#c4b08a') + '<figcaption>Nuovi tesseramenti</figcaption></figure>' +

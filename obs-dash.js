...
(function () {
  ...
  function html(user) {
    ...
    return '<aside class="es-pd-rail">' +
      ...
      '<figure>' + spark([32, 40, 48, 55, 64, 74, 86], '#c4b08a') + '<figcaption>Segnalazioni confermate</figcaption></figure>' +
      '<figure>' + spark([28, 36, 44, 52, 60, 72, 84], '#8a9a7a') + '<figcaption>Giocatori segnalati</figcaption></figure>' +
      '<figure>' + spark([20, 28, 32, 40, 48, 58, 70], '#c4b08a') + '<figcaption>Partite visionate</figcaption></figure>' +

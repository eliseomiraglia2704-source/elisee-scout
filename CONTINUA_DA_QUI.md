...
Ultimo fatto: **Tassonomia Completa Categorie Calcistiche Italiane & Scadenziario Federale Reale per Ambito (Stagione 2026/2027)**: 1. Strutturati i 4 Ambiti federali distinti (*Professionistico Co.Vi.So.C., Dilettantistico LND/Regionali, Giovanile SGS/Primavera, Femminile Divisione FIGC/LND*) con elenco completo di tutte le categorie e le 20 Regioni italiane; 2. Implementato in testata all'Area Presidente il selettore dinamico a cascata (Ambito -> Categoria -> Comitato Regionale) con banner di avviso aggiornamento stagionale 2026/27; 3. Popolati i template con termini perentori reali Co.Vi.So.C. (16 giugno 2026 bilancio/licenza, 6 luglio IVA, fideiussioni € 800k Serie B / € 350k Serie C, liberatorie neopromosse), Serie D (iscrizione 3-10 luglio ore 14:00, fideiussione € 31.000, ricorsi Co.Vi.So.D 23 luglio) e stato *"Da impostare in base al Comitato Regionale di competenza"* per i livelli regionali; 4. Modale di gestione scadenziario con modifica inline, conto alla rovescia dinamico, aggiunta custom e ripristino default ambito. File: `pres-dash.js`, `index.html`, `sw.js`. Cache `TAXONOMY_DEADLINES1`.
Feature precedente: Integrazione Obblighi Riforma dello Sport (D.Lgs. 36/2021 & D.Lgs. 120/2023) in Conformità & Governance.

...
Ultimo fatto: **Logo Ufficiale Sant'Agostino HD integrato** — Scaricato e configurato il logo originale in alta definizione per il Sant'Agostino (`ecc-sant-agostino.png` e `sant-agostino.png`) nel catalogo loghi societari `immagini/squadre-loghi/`.

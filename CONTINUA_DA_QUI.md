...
Ultimo fatto: **Scadenzario Federale: Stato "Completato", Data Reale di Assolvimento & Rimozione Duplicazione Fideiussione**: 1. Distinto il concetto di *termine di calendario passato* da *adempimento non assolto*: implementato il toggle interattivo "Segna come completato" / "Riapri come da svolgere" su ogni singola voce dello scadenziario; 2. Aggiunto il campo editabile per la registrazione della data reale di completamento (`completedDate`), con codice colore verde e badge di assolvimento (`✅ Completato il [data]`); 3. Le voci completate non contribuiscono più al conteggio degli adempimenti pendenti/scaduti nel badge di allerta della card overview (che ora mostra solo quelli realmente da assolvere, o *"Tutti completati (N/N)"* con badge verde quando tutti gli adempimenti sono stati eseguiti); 4. Rimossa la menzione duplicata dell'importo fideiussione (€ 31.000) dalla riga *Iscrizione Campionato Nazionale Serie D*, lasciando il dato economico unicamente nella riga autonoma *Deposito Fideiussione Bancaria (€ 31.000 con scad. 12/07/2027)*; 5. Allineato il dataset dimostrativo e quello reale. File: `pres-dash.js`, `index.html`, `sw.js`. Cache `DEADLINES_COMPL1`.
Feature precedente: Tassonomia Completa Categorie Calcistiche Italiane & Scadenziario Federale Reale per Ambito (Stagione 2026/2027).

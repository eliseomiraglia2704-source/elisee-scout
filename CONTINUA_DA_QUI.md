...
Ultimo fatto: **Logo Ufficiale Arcetana HD integrato** — Scaricato e configurato il logo originale in alta definizione per l'Arcetana (`ecc-arcetana.png` e `arcetana.png`) nel catalogo loghi societari `immagini/squadre-loghi/`.

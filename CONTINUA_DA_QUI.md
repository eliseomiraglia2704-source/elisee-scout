...
Ultimo fatto: **Integrazione Logo Ufficiale Santa Maria la Carità (Eccellenza Campania Girone A)** — Scaricato e integrato il logo ad alta risoluzione in `immagini/squadre-loghi/ecc-santa-maria-la-carita.png` collegato al catalogo squadre e a focus.html. Cache `SANTAMARIA1`.
Feature precedente: **Integrazione Logo Ufficiale Real Grazzanise** — Cache `GRAZZANISE1`.

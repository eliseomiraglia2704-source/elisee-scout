...
Ultimo fatto: **Logo Ufficiale Rolo Fabbrico HD integrato** — Scaricato e configurato il logo originale in altissima definizione per il Rolo Fabbrico (`ecc-rolo-fabbrico.png`, `rolo-fabbrico.png`, `rolo.png`) nel catalogo loghi societari `immagini/squadre-loghi/`.

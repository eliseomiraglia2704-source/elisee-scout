...
(function () {
  ...
  function html(user) {
    ...
    return '<aside class="es-pd-rail">' +
      ...
      '<figure>' + spark([28, 36, 44, 52, 60, 72, 86], '#c4b08a') + '<figcaption>Ricavi sponsor</figcaption></figure>' +
      '<figure>' + spark([24, 32, 40, 48, 56, 68, 80], '#8a9a7a') + '<figcaption>Vendite merchandising</figcaption></figure>' +
      '<figure>' + spark([18, 26, 34, 42, 50, 62, 76], '#c4b08a') + '<figcaption>Nuove partnership</figcaption></figure>' +

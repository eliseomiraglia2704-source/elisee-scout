# -*- coding: utf-8 -*-
"""Organico ufficiale Eccellenza Toscana Girone B 2026/27 + loghi Tuttocampo."""
...
SHOTS = [
    {
        "file": "image-b01ef9b2-4fee-4870-9609-5d5ec3fffa06.png",
        "league": "ECCELLENZA · TOSCANA · GIRONE B",
        "gid": "toscana-b",
        "title": "Toscana · Girone B",
        "area": "Eccellenza · organico ufficiale 2026/27 (16 squadre)",
        "pairs": [
            (("Antella 99", "Antella"), ("Montespertoli", "Montespertoli")),
            (("Audax Rufina", "Rufina"), ("Poggibonsi", "Poggibonsi")),
            (("Baldaccio Bruni", "Anghiari"), ("Sangiovannese", "San Giovanni Valdarno")),
            (("Barberino Tavarnelle", "Barberino Tavarnelle"), ("Sansovino", "Monte San Savino")),
            (("Castiglionese", "Castiglion Fiorentino"), ("Sestese", "Sesto Fiorentino")),
            (("Colligiana", "Colle di Val d'Elsa"), ("Signa 1914", "Signa")),
            (("Figline 1965", "Figline Valdarno"), ("Asta Taverne", "Siena")),
            (("Lastrigiana", "Lastra a Signa"), ("Valentino Mazzola", "Siena")),
        ],
    },
]
